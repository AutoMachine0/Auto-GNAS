...
class Attention(torch.nn.Module):
    ...
    def __init__(self,
        ...
        glorot(self.a)
        self.general_att_layer = torch.nn.Linear(self.output_dim, 1, bias=False)
    ...
    def function(self,
        ...
        for index in range(self.heads):
            ...
            if index == 0:
                ...
                e = torch.tanh(e)
                e = self.general_att_layer(e)
            else:
                e_ = x_i[index] * a_l + x_j[index] * a_r
                e_ = torch.tanh(e_)
                e_ = self.general_att_layer(e_)
