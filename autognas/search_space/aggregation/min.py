...
class Aggregation(torch.nn.Module):
      """
   Realizing min aggregation manner for the source_node_representation_with_coefficient
   ...
   """
    ...
    def function(self,
                 ...
                 edge_index):
        node_representation_agg_based_on_edge_target, _ = scatter_min(source_node_representation_with_coefficient,
                                                                      edge_index[1],
                                                                      dim=0)
