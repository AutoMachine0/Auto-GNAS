...
if __name__=="__main__":
    ...
    # print("get data cost time:", time.time()-t)
    # t1 = time.time()
    ...
    #                  )
    # t2 = time.time()
    # print("modeling cost time:", t2-t1)

    graph = Planetoid("cora", shuffle_flag=None).data

    # model = StackGcn(graph,
    #                  train_epoch=300,
    #                  gnn_architecture=['gat', 'sum',  1, 64, 'tanh', 'gat', 'sum', 1, 64, 'tanh'],
    #                  downstream_task_type="node_classification",
    #                  val_evaluator_type="accuracy",
    #                  test_evaluator_type=["accuracy", "precision", "recall", "f1_value"])
    ...
    model = StackGcn(graph,
                     train_epoch=20,
                     gnn_architecture=['linear', 'sum', 4, 16, 'linear', 'gcn', 'sum', 2, 32, 'tanh'],
                     downstream_task_type="node_classification",
                     val_evaluator_type="accuracy",
                     test_evaluator_type=["accuracy", "precision", "recall", "f1_value"])
    ...
    # model = StackGcn(graph,
    #                  gnn_architecture=['gat', 'sum', 2, 64, 'tanh', 'gat', 'sum', 2, 64, 'tanh'],
