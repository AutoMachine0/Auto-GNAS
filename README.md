...
- Layer number
    - user can defind this parameter in the [configuration file in the gnn_parameter gnn_layers](https://github.com/AutoMachine0/Auto-GNAS/blob/master/config/node_classification_config/graphpas.ini) 
